<template>
  <div>
    ...
    <!-- 分页 -->
    <List :current="current" :columns="columns" :data="businesstake.businesstakes.page.list"
          :total="businesstake.businesstakes.page.total"
...
//            width: 125
    ...
    methods: {
      ...
      get (current = 1) {
        ...
        this.$store.dispatch('getBusinesstakes', {
          params: {
