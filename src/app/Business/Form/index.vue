<template>
  <div>
    <Breadcrumb>
      ...
      <Breadcrumb-item href="/articles">商家列表</Breadcrumb-item>
      <Breadcrumb-item>商家{{ id ? '编辑' : '新增' }}</Breadcrumb-item>
    </Breadcrumb>
    <div>
      <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
        <Form-item label="标题" prop="title">
          <Row>
            <Col span="12">
              <Input v-model="formValidate.title" placeholder="请输入商家名"></Input>
            </Col>
          </Row>
        </Form-item>
